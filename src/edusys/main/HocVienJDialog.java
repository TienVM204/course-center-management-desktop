...
public class HocVienJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CHUYÊN ĐỀ", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "KHÓA HỌC", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    void fillTableNguoiHoc(){
        ...
        for(NguoiHoc nguoiHoc: list){
            model.addRow(new Object[]{
                nguoiHoc.getMaNH(),nguoiHoc.getHoTen(),nguoiHoc.getGioiTinh()?"Nam":"Nữ",
    ...
    void xoaHocVien(){
        if(!Auth.isManager()){
            ...
            if(rows.length > 0 && 
                    MsgBox.confirm(this, "Bạn muốn xóa học viên không")){
                for(int row : rows){
