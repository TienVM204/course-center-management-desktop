...
public class NhanVienJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblNhanVien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã nhân viên", "Mật khấu", "Họ và tên", "VAI TRÒ"
            }
        ) {
    ...
    void clearForm() {
        NhanVien nv = new NhanVien();//tao ra nv rong roi set len form
        this.setForm(nv);
        this.row = -1;
        this.updateStatus();
    }
    ...
    void delete() {
        if (!Auth.isManager()) {
            MsgBox.alert(this, "Bạn không có quyên xóa nhân viên !");
        } else {
    ...
    void setForm(NhanVien nv) {
        ...
        txtMatKhau2.setText(nv.getMaNV());
